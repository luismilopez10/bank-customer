...
public interface CustomerMapper {
	...
	public List<CustomerDTO> customerListCustomerDTOList(List<Customer> customers);
	
	public List<Customer> customerDTOListToCustomerList(List<CustomerDTO> CustomersDTO);
}
